...
trait CommandsPlugin extends ScalaPlugin with MinecraftParsers {
  ...
  object ConsolePlayer {
    ...
    val player = new Player {
      ...
      override def launchProjectile[T <: Projectile](p1: Class[_ <: T], p2: Vector): T = ???

      override def setStatistic(p1: Statistic, p2: EntityType, p3: Int): Unit = ???

      override def decrementStatistic(p1: Statistic, p2: EntityType, p3: Int): Unit = ???

      override def incrementStatistic(p1: Statistic, p2: EntityType, p3: Int): Unit = ???

      override def getStatistic(p1: Statistic, p2: EntityType): Int = ???

      override def decrementStatistic(p1: Statistic, p2: EntityType): Unit = ???

      override def incrementStatistic(p1: Statistic, p2: EntityType): Unit = ???

      override def setStatistic(p1: Statistic, p2: Material, p3: Int): Unit = ???

      override def decrementStatistic(p1: Statistic, p2: Material, p3: Int): Unit = ???

      override def getStatistic(p1: Statistic, p2: Material): Int = ???

      override def decrementStatistic(p1: Statistic, p2: Material): Unit = ???

      override def getStatistic(p1: Statistic): Int = ???

      override def setStatistic(p1: Statistic, p2: Int): Unit = ???

      override def decrementStatistic(p1: Statistic, p2: Int): Unit = ???

      override def decrementStatistic(p1: Statistic): Unit = ???

      override def hasAchievement(p1: Achievement): Boolean = ???

      override def removeAchievement(p1: Achievement): Unit = ???

      override def sendSignChange(p1: Location, p2: Array[String]): Unit = ???
    }
  }
}
